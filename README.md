...
```html
<script src="https://js.zumo.money/2.3.0-alpha.21/decimal.js"></script>
<script src="https://js.zumo.money/2.3.0-alpha.21/zumokit.js"></script>
```
...
<body>
  ...
  <script src="https://js.zumokit.com/2.3.0-alpha.21/decimal.js"></script>
  <script src="https://js.zumokit.com/2.3.0-alpha.21/zumokit.js"></script>
</body>
