...
export interface User {
   ...
   */
  createFiatAccount(network: Network, currencyCode: CurrencyCode): Promise<any>;
   ...
   */
  getNominatedAccountFiatProperties(accountId: string): Promise<any>;
  /**
